    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-aureus-navy to-blue-900 flex items-center justify-center py-12 px-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-2xl p-8">
          <h2 className="text-3xl font-bold text-aureus-navy mb-6 text-center">Welcome Back</h2>
          ...
          <p className="text-center text-gray-600 mt-6">
            ...
            <Link to="/signup" className="text-aureus-gold font-semibold hover:underline">
              Sign up
            </Link>
          </p>
        </div>
